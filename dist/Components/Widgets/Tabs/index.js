...
Tabs=function(_NativeBaseComponent){_inherits(Tabs,_NativeBaseComponent);




function Tabs(props){_classCallCheck(this,Tabs);var _this=_possibleConstructorReturn(this,(Tabs.__proto__||Object.getPrototypeOf(Tabs)).call(this,
props));

_this.goToPage=_this.goToPage.bind(_this);return _this;
}_createClass(Tabs,[{key:'goToPage',value:function goToPage(
...
}}]);return Tabs;}(_NativeBaseComponent3.default);exports.default=Tabs;
